...
namespace DataSift
{
    internal class Messages
    {
        ...
        internal const string INVALID_RECORDING_ID = "ID should be a 40 character string of lower-case letters and numbers";
        internal const string INVALID_TASK_ID = "ID should be a 40 character string of lower-case letters and numbers";
